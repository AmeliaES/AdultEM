...
plot3d(MVP2.subset, col = 'red', lwd = 3, WithConnectors = FALSE, WithNodes = FALSE, alpha = 0.5)
...
points3d(VPM3.inputs[,c('connector_x','connector_y','connector_z')], col="firebrick3", size=7)
points3d(VPM4.inputs[,c('connector_x','connector_y','connector_z')], col="firebrick3", size=7)
points3d(y4y1y2.inputs[,c('connector_x','connector_y','connector_z')], col="darkorange1", size=7)
points3d(APL.inputs[,c('connector_x','connector_y','connector_z')], col="darkslategray1", size=7)
KCy.points <- lapply(1:length(KCy.inputs), function(x) points3d(KCy.inputs[[x]][,c('connector_x','connector_y','connector_z')], col="gold1", size=7))
points3d(aut.inputs[,c('connector_x','connector_y','connector_z')], col="dodgerblue4", size=7)
KCaB.points <- lapply(1:length(KCaB.inputs), function(x) points3d(KCaB.inputs[[x]][,c('connector_x','connector_y','connector_z')], col="darkolivegreen", size=7))
MP1.points <- lapply(1:length(MP1.inputs), function(x) points3d(MP1.inputs[[x]][,c('connector_x','connector_y','connector_z')], col="darkorchid2", size=7))
